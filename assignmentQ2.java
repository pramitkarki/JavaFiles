...
public class pan_num {
    ...
    public static void main(String[] args) throws pan_exep{
        ...
        try{    
            ...
            System.out.println("This may be a valid PAN number");
                
            if(Ind){
                System.out.println("It belongs to an indivisual.");
            }else{
                System.out.println("It belongs to a non-indivisual.");
            }
        }catch(pan_exep e){
